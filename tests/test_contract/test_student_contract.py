...
class TestStudentContract:
    ...
    def test_update_student_fails_on_email_taken(self, student_helper, group_helper):
        ...
        existing_student = StudentResponse(**student_helper.post_student(
            GenerateUtils.random_student_data(group_id)).json())

        new_student = student_helper.post_student(GenerateUtils.random_student_data(group_id))
