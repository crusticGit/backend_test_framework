...
from services.auth.models.register_request import RegisterRequest, PASSWORD_MIN_LENGTH, PASSWORD_MAX_LENGTH
...
class TestAuthContract:
    ...
    def test_login_invalid_password(self, auth_helper, generate_valid_password):
        ...
        login_data = {
            "username": name,
            "password": faker.password(length=random.randint(PASSWORD_MIN_LENGTH,
                                                             PASSWORD_MAX_LENGTH),
                                       special_chars=True,
                                       digits=True,
                                       upper_case=True,
