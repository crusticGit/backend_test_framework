...
class TestAuth:
    def test_successful_user_registration_flow(self, auth_api_utils_anonym):
        ...
        register_response = auth_service.register_user(register_request=register)
    ...
    def test_successful_login_after_registration(self, auth_api_utils_anonym):
        auth_service = AuthService(api_utils=auth_api_utils_anonym)
        ...
        assert login_response.access_token, "access token should not be empty"
    ...
    def test_complete_user_lifecycle_registration_login_get_user_info(self, auth_api_utils_anonym):
        ...
        user_info_response = auth_service.get_user_info()
    ...
    def test_registration_validation_error_model_email_is_empty(self, auth_api_utils_anonym):
        auth_service = AuthService(api_utils=auth_api_utils_anonym)
