...
class TestGrade:
    ...
    def setup_grade_data(self, university_service_admin):
        ...
        for i in range(random.randint(0, 10)):
            ...
            grade = university_service_admin.create_grade(grade_request=GradeRequest(**grade_data))
    ...
    def test_statistics_count(self, setup_grade_data, university_service_admin):
        ...
        response = university_service_admin.get_grade_statistics(student.id, teacher.id, student.group_id)

        expected_result = len(grades)
        actual_result = response.count

        assert actual_result == expected_result, (f'Grade stats count not correct'
                                                  f'Actual: {actual_result}, '
                                                  f'but expected: {expected_result}')
    ...
    def test_statistics_min_grade(self, setup_grade_data, university_service_admin):
        ...
        assert actual_result == expected_result, (f'Grade stats min not correct'
                                                  f'Actual: {actual_result}, '
                                                  f'but expected: {expected_result}')
    ...
    def test_statistics_max_grade(self, setup_grade_data, university_service_admin):
        ...
        assert actual_result == expected_result, (f'Grade stats max not correct'
                                                  f'Actual: {actual_result}, '
                                                  f'but expected: {expected_result}')
    ...
    def test_statistics_avg_grade(self, setup_grade_data, university_service_admin):
        ...
        assert actual_result == expected_result, (f'Grade stats avg not correct'
                                                  f'Actual: {actual_result}, '
                                                  f'but expected: {expected_result}')
