...
class TestGrade:
    ...
    def test_create_grade(self, university_service_admin):
        ...
        assert actual_result == expected_result, (
            f"Grade details mismatchActual: {actual_result}, but expected: {expected_result}"
        )
    ...
    def test_statistics_count(self, setup_grade_data, university_service_admin):
        ...
        assert actual_result == expected_result, (
            f"Grade stats count not correctActual: {actual_result}, but expected: {expected_result}"
        )
    ...
    def test_statistics_min_grade(self, setup_grade_data, university_service_admin):
        ...
        assert actual_result == expected_result, (
            f"Grade stats min not correctActual: {actual_result}, but expected: {expected_result}"
        )
    ...
    def test_statistics_max_grade(self, setup_grade_data, university_service_admin):
        ...
        assert actual_result == expected_result, (
            f"Grade stats max not correctActual: {actual_result}, but expected: {expected_result}"
        )
    ...
    def test_statistics_avg_grade(self, setup_grade_data, university_service_admin):
        ...
        assert actual_result == expected_result, (
            f"Grade stats avg not correctActual: {actual_result}, but expected: {expected_result}"
        )
